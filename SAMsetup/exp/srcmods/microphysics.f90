...
character*3, dimension(nmicro_fields) :: mkfname
character*80, dimension(nmicro_fields) :: mkflongname
character*10, dimension(nmicro_fields) :: mkfunits
...
subroutine micro_init()
  ...
  mkfname(1) = 'FQT'
  mkflongname(1) = 'SGS tendency for TOTAL WATER (VAPOR + CONDENSATE)'
  mkfunits(1) = 'W/m3'

  mkfname(2) = 'FQP'
  mkflongname(2) = 'SGS tendency for PRECIPITATING WATER'
  mkfunits(2) = 'W/m3'
